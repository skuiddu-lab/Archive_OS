...
const JOINT_OPS = [
    // --- UNIVERSAL OPS (Per tutti) ---
    {
        id: 'basic_sync', name: 'Neural Handshake',
        reqLvl: 1, cost: 5, duration: 5000,
        staminaCost: 5, hpCost: 10,
        syncGain: 1.5, xpGain: 50,
        trustMod: 1, stressMod: 0, // Leggero aumento fiducia
        desc: "Basic connection. Safe and stable."
    },
    {
        id: 'deep_dive', name: 'Memory Dive',
        reqLvl: 5, cost: 50, duration: 20000,
        staminaCost: 40, hpCost: 100,
        syncGain: 8.5, xpGain: 400,
        trustMod: 2, stressMod: 5, // Stressante ma efficace
        desc: "Direct interface. High mental load."
    },

    // --- MALE SPECIFIC (Focus: Combat & Respect) ---
    {
        id: 'sparring_sim', name: 'Combat Sparring',
        reqLvl: 3, cost: 20, duration: 10000,
        staminaCost: 20, hpCost: 80, // Danno fisico alto
        syncGain: 4.0, xpGain: 250,
        reqSex: 'MALE', // Solo Maschi
        trustMod: 2, stressMod: 2, // Rispetto reciproco
        desc: "[MALE] Shared combat drill. Builds brotherhood."
    },
    {
        id: 'command_drill', name: 'Hierarchy Drill',
        reqLvl: 10, cost: 80, duration: 15000,
        staminaCost: 30, hpCost: 40,
        syncGain: 6.0, xpGain: 100,
        reqSex: 'MALE',
        trustMod: -1, stressMod: 5, // Aumenta Stress/Paura (Obedience)
        desc: "[MALE] Forced discipline protocols. Enforces obedience."
    },

    // --- FEMALE SPECIFIC (Focus: Emotion & Care) ---
    {
        id: 'tea_sync', name: 'Sensory Resonance',
        reqLvl: 3, cost: 30, duration: 15000,
        staminaCost: 15, hpCost: 10, // Danno basso
        syncGain: 5.0, xpGain: 100,
        reqSex: 'FEMALE', // Solo Femmine
        trustMod: 4, stressMod: -2, // Riduce Stress, Molta Fiducia
        desc: "[FEMALE] Emotional harmonization. Reduces stress."
    },
    {
        id: 'core_bind', name: 'Devotion Ritual',
        reqLvl: 10, cost: 100, duration: 30000,
        staminaCost: 60, hpCost: 150,
        syncGain: 15.0, xpGain: 500,
        reqSex: 'FEMALE',
        trustMod: 5, stressMod: 5, // Intenso emotivamente
        desc: "[FEMALE] Deep emotional bonding. Extreme load."
    },

    // --- ENTITY SPECIFIC (Focus: Abstract & Alien) ---
    {
        id: 'void_stare', name: 'Void Gazing',
        reqLvl: 5, cost: 40, duration: 12000,
        staminaCost: 50, hpCost: 0, // Niente danno fisico, tutto mentale
        syncGain: 10.0, xpGain: 300,
        reqSex: 'ENTITY', // Solo Entity/Monster
        trustMod: 0, stressMod: 10, // Terrore puro
        desc: "[ENTITY] Stare into the abyss together."
    }
];